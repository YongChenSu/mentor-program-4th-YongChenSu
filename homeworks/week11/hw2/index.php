  ...
  <main class="main__articles">
      ...
      <?php if(empty($username)) { ?>
        <?php while($row = $result->fetch_assoc()) { ?>
          <div class="article">
            ...
            <div class="content"><?php echo escape($row['article']) ?></div>
    ...
    <?php if (!empty($username)) {
      $sql = "SELECT count(id) as count FROM yongchen_articles as A
        WHERE A.is_deleted IS NULL AND A.username = '$username'";
    ...
    <section class="paginator">
      <div class="pre__most">
        <a class="page__first" href="./index.php?page=1">FIRST PAGE</a>
        <a class="page__pre" href="./index.php?page=<?php echo $page - 1 < 1 ? (1) : ($page - 1) ?>">PRE</a>
      </div>
      ...
      <div class="next__most">
        <a class="page__next" href="./index.php?page=<?php echo $page + 1 > $total_page ? ($total_page) : ($page + 1) ?>">NEXT</a>
        <a class="page__last" href="./index.php?page=<?php echo $total_page ?>">LAST PAGE</a>
      </div>
    </section>
  <main>
</body>
