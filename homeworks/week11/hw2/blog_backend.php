...
<body>
  ...
  <main class="main__articles">
    ...
    <section class="paginator">
      <div class="pre__most">
        <a class="page__first" href="./blog_backend.php?page=1">FIRST PAGE</a>
        <a class="page__pre" href="./blog_backend.php?page=<?php echo $page - 1 < 1 ? (1) : ($page - 1) ?>">PRE</a>
      </div>
      ...
      <div class="next__most">
        <a class="page__next" href="./blog_backend.php?page=<?php echo $page + 1 > $total_page ? ($total_page) : ($page + 1) ?>">NEXT</a>
        <a class="page__last" href="./blog_backend.php?page=<?php echo $total_page ?>">LAST PAGE</a>
      </div>
    </section>
  <main>
</body>
